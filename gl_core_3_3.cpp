	...
	namespace sys
	{
		namespace 
		{
			...
			void InitializeMappingTable(std::vector<MapEntry> &table)
			{
				...
				table.push_back(MapEntry("GL_NV_texture_barrier", &exts::var_NV_texture_barrier, Load_NV_texture_barrier));
				table.push_back(MapEntry("GL_NV_copy_image", &exts::var_NV_copy_image, Load_NV_copy_image));
			}
