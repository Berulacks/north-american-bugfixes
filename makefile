all:
	...
	g++ -c physics.cpp -ggdb -Wwrite-strings -std=c++11  -lGL -lGLU -lSDL2 -lSOIL -lassimp -o physics.o && \
...
phys1:
	make && \
	g++ -L. phys1.cpp -Wwrite-strings -std=c++11 -ggdb  -lGL -lGLU -lSDL2 -lSOIL -lassimp -lNab -o phys1
